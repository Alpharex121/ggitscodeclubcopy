...
const ResourcesCard = ({ title, description, tag, link, moredescription }) => {
  ...
  return (
    <div
      className="rounded-lg shadow-lg bg-white sm:w-[80vw] my-3 mx-5 border bg-card text-card-foreground  "
      data-v0-t="card"
    >
